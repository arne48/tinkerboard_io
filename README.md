...
_This struct contains the configurations to initialize the SPI controller with.
Important: data_frame_size and transfer_mode are exposed for eventual customizations.
